 ...
 * @param <FontType>
 */
public abstract class AbstractExcelReporter<S, R,ColorType, FontType> extends AbstractReporter<S, R> {
    ...
    public AbstractExcelReporter(BiFunction<Integer, S, R> writeRow) {
        super(writeRow);
    }
